...
import styles from "../assets/styles/faq/FAQ.css";
        ...
        <div className="faq-item">
          ...
          {openQuestion === 1 && (
            <div className={`faq-answer ${openQuestion === 1 ? "open" : ""}`}>
              <p>
                To budget effectively, start by tracking your income and
                expenses. Identify essential expenses like rent, groceries, and
                utilities, and set realistic goals for savings. You can use
                budgeting tools like spreadsheets or apps to help manage your
                finances.
              </p>
            </div>
          )}
        ...
        <div className="faq-item">
          ...
          {openQuestion === 2 && (
            <div className={`faq-answer ${openQuestion === 2 ? "open" : ""}`}>
              <p>
                Start saving for retirement by contributing to a 401(k) or an
                IRA. Many employers offer a matching contribution, which is
                essentially free money. You should also diversify your
                investments and adjust your portfolio based on your retirement
                timeline.
              </p>
            </div>
          )}
          ...
          {openQuestion === 3 && (
            <div className={`faq-answer ${openQuestion === 3 ? "open" : ""}`}>
              <p>
                ...
                keeping your credit utilization low, and avoiding opening too
                many new accounts. Regularly checking your credit report for
                errors can also help improve your score over time.
              </p>
            </div>
          )}
        </div>

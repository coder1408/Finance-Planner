  ...
  return (
    <div className="bod">
        ...
        <p className="about-text">
            PrimePlan Financials is your personal financial planner and tracker designed to help you make well-informed decisions regarding loans, budgeting, and expenses. With a user-friendly interface and a range of powerful tools, PrimePlan Financials offers:
        </p>
